...
int main(int argc, char **argv) {
    ...
    int pic_num = 0;
    char temp[16];
    char folder_num_char[16];
    string folder = "/home/dvrk/Desktop/yida_pictures/";
    string name;
    string folder_num;
    string folder_touch;
    string folder_not_touch;
    ...
    for (int j=0; j<10; j++){
        ...
        sprintf(folder_num_char,"%d",j);
        string folder_num(folder_num_char);
        folder_touch = "/home/dvrk/Desktop/yida_pictures/touch/"+folder_num+"/";
        folder_not_touch = "/home/dvrk/Desktop/yida_pictures/not_touch/"+folder_num+"/";
        mkdir(folder_touch.c_str(),0777);
        mkdir(folder_not_touch.c_str(),0777);
        ...
        while (weight_data <= 2.5){
            ...
            if (freshImage){
                ...
                string file(temp);
                if (weight_data>0.1){
                    name = folder+"touch/"+folder_num+"/"+file+".png";
                }
                else{
                    name = folder+"not_touch/"+folder_num+"/"+file+".png";
                }
